package com.cc.gateway.admin.service.impl;
...
import com.cc.gateway.admin.config.BusConfig;
import com.cc.gateway.admin.dao.GatewayRouteMapper;
...
import com.cc.gateway.admin.events.EventSender;
...
public class GatewayRouteServiceImpl extends ServiceImpl<GatewayRouteMapper, GatewayRoute> implements GatewayRouteService {
    ...
    private RouteDefinition gatewayRouteToRouteDefinition(GatewayRoute gatewayRoute) {
        ...
        routeDefinition.setOrder(Integer.parseInt(gatewayRoute.getOrders()));
